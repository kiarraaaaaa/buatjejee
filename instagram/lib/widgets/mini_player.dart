...
import '../screens/now_playing_screen.dart'; // ✅ tambahan
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<int>(
      ...
      builder: (context, currentIndex, child) {
        ...
        // ✅ dibungkus GestureDetector (INI SAJA PERUBAHANNYA)
        return GestureDetector(
          onTap: () {
            if (song["title"] == "Swimming Pool" || song["title"] == "Him and I" || song["title"] == "The Machine" || song["title"] == "Fetish" || song["title"] == "Again" || song["title"] == "Flatline" || song["title"] == "Shameless" || song["title"] == "Boyfriend" || song["title"] == "The Fate of Ophelia" || song["title"] == "The Man Who Can't Be Moved") {
              Navigator.push(
                context,
                PageRouteBuilder(
